...
def calculateDistanceVectorFromOutputsByRef(sourceLayerOutputs, refNeuronOutput, distance_function,distance_function_option=None):
    """
    ...
    for i in range(num_neurons):
        if sourceLayerOutputs.dim() == 2:
            ...
            distance_vector[i] = distance_function(sourceLayerOutputs[:, i], refNeuronOutput,distance_function_option)
...
distance_vector_2d = calculateDistanceVectorFromOutputsByRef(sourceLayerOutputs_2d, refOutput, example_distance_function,option)
print("Distance Matrix (2D):\n", distance_vector_2d)

sourceLayerOutputs_3d = torch.randn(10, 5, 3)
refOutput = torch.randn(10,3)

distance_vector_3d = calculateDistanceVectorFromOutputsByRef(sourceLayerOutputs_3d, refOutput, example_distance_function,option)
print("Distance Matrix (3D):\n", distance_vector_3d)

sourceLayerOutputs_4d = torch.randn(10, 5, 4, 4)
refOutput = torch.randn(10,4,4)

distance_vector_4d = calculateDistanceVectorFromOutputsByRef(sourceLayerOutputs_4d, refOutput, example_distance_function,option)
